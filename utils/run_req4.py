...
Baseline: the same dynamic clairvoyant as Requirement 3 (see
experiments.py's compute_clairvoyant_dynamic_multi docstring for why a
cheaper "one static action per interval" benchmark would be a weaker,
different notion of optimal-in-hindsight, not just a shortcut).
